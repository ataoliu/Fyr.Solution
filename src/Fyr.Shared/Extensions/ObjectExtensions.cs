...
public static class ObjectExtensions
{
    ...
    // {
    //     return useJson ? InternalJsonCopy(original) : (T)InternalCopy(original, new Dictionary<object, object>(new ReferenceEqualityComparer())) ?? default;
    // }
...
// #endif
    ...
    //     if (visited != null && visited.TryGetValue(originalObject, out var copy))
    //     {
    //         return copy;
    //     }
    ...
    //         if (arrayType != null && cloneObject != null && !IsPrimitive(arrayType))
    //         {
    ...
    //     if (cloneObject != null && visited != null)
        ...
        if (value != null)
        {
            if (value is IDictionary dic)
            {
                foreach (DictionaryEntry e in dic)
                {
                    ...
                    object thisValue = e.Value ?? string.Empty;
                    // if(e.Key!=null && e.Value != null)
                    dictionary.Add(key, thisValue);
                }
                return dictionary;
            }
